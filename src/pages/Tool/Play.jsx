            ...
            <PageContainer>
                ...
                <Card style={{marginTop: 8}}>
                    ...
                    <Row style={{marginTop: 10}}>
                        <Button onClick={this.updatePlayerInfo} type="primary" size='large' style={{marginRight: 30,width: 120 }}>Update</Button>
                        <Button onClick={this.play} type="primary" size='large' style={{marginRight: 30,width: 120 }}>play</Button>
                        <Button onClick={this.pause} type="primary" size='large' style={{marginRight: 30,width: 120 }}>pause</Button>
                        <Button onClick={this.load} type="primary" size='large' style={{marginRight: 30,width: 120 }}>load</Button>

                        <Button onClick={this.setMuted(true)} type="primary" size='large' style={{marginRight: 30,width: 120 }}>muted=true</Button>
                        <Button onClick={this.setMuted(false)} type="primary" size='large' style={{marginRight: 30,width: 120 }}>muted=false</Button>
                    </Row>
                </Card>
            </PageContainer>
        )
